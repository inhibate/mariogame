...
import FBC from '../FloorBoxComponent'
...
export default class L11Container {
	constructor() {
		...
		this.NPCComponents = {
			'npc-goomba1': new NPCGoomba(120 + delta * 10, SCENEH - FLOORH - delta - 256, 1)
		}
		...
		this.NCCComponents = {
			...
			'fbc4': new FBC(delta * (71 + 15 + 3 + 64 + 2), SCENEH - FLOORH, delta * 53, FLOORH),
			...
			'ttc89': new TTC(120 + 64, SCENEH - FLOORH - delta)
		}
	}
}